...
-- Use partial index so only the 'live' mappings are checked.
CREATE UNIQUE INDEX unique_live_mapping_constraint
    ON mappings.concept_relationship (concept_id_1, concept_id_2, relationship_id)
    WHERE invalid_reason IS NULL;